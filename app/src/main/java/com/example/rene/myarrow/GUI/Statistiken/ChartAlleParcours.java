...
public class ChartAlleParcours extends AppCompatActivity implements OnChartValueSelectedListener {

    /** Kuerzel fuers Logging. */
    private static final String TAG = ChartAlleParcours.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart.setData(data);
        chart.setDescription("Alle Parcoure");
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h){
        ...
        Log.d(TAG, "onValueSelected(): Parcour - " + xAxis.get(e.getXIndex()));
        Toast.makeText(this, xAxis.get(e.getXIndex()), Toast.LENGTH_SHORT).show();
        final Intent i = new Intent(this, ChartEinParcourAlleSchuetzen.class);
        i.putExtra(Konstante.IN_PARAM_PARCOUR_GID, rs[e.getXIndex()][0]);
        startActivity(i);
    ...
    private ArrayList<IBarDataSet> getDataSetChart() {
        ...
        BarDataSet barDataSet1 = new BarDataSet(valueSet1, "Alle Parcours");
    ...
    private void saveChart() {
        if (!bFileChart){
            String mTitle = "MYA_Alle_Parcours";
